              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    className="group/reset text-[#333] hover:text-[#f14110] transition-colors"
                    title="Reset filters"
                  >
                    <svg width="16" height="16" viewBox="0 0 21 21" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                      <path d="M7.07812 0.547852C9.47004 -0.260526 12.0746 -0.171686 14.4062 0.796875C16.7379 1.76567 18.639 3.54903 19.7539 5.81445C20.8688 8.0801 21.1218 10.6746 20.4668 13.1133C19.8116 15.5518 18.2924 17.6693 16.1924 19.0713C14.0923 20.4731 11.5541 21.0644 9.05078 20.7344C6.5475 20.4042 4.24892 19.1756 2.58398 17.2773C0.91918 15.379 0.000793815 12.9399 0 10.415C-3.13726e-06 9.863 0.447968 9.41441 1 9.41406C1.55203 9.41406 1.99964 9.86205 2 10.4141C2.00058 12.4539 2.74294 14.4243 4.08789 15.958C5.43302 17.4917 7.29005 18.4843 9.3125 18.751C11.3349 19.0176 13.3854 18.5407 15.082 17.4082C16.7788 16.2755 18.0059 14.564 18.5352 12.5938C19.0643 10.6237 18.8596 8.52857 17.959 6.69824C17.0583 4.868 15.5234 3.42629 13.6396 2.64355C11.7559 1.861 9.65119 1.78937 7.71875 2.44238C6.37519 2.89652 5.17904 3.68073 4.23047 4.70898H6.88281C7.43502 4.70908 7.88281 5.15676 7.88281 5.70898C7.88269 6.26111 7.43494 6.70889 6.88281 6.70898H2.17676C1.62458 6.70895 1.17688 6.26114 1.17676 5.70898V1.00293C1.17676 0.450664 1.6245 0.00296074 2.17676 0.00292969C2.72904 0.00292969 3.17676 0.450645 3.17676 1.00293V2.92773C4.27706 1.86378 5.60585 1.04549 7.07812 0.547852Z"/>
                    </svg>
                  </button>
                </div>
