...
export function StatsCard({
  ...
  return (
    <div className="relative w-[210px] h-[230px] bg-[#333] rounded-[6px] overflow-hidden">
      {/* Action Buttons */}
      ...
      <div className="absolute bottom-[10px] left-[10px] right-[10px] flex items-center justify-between">
        ...
        <button className="w-[36px] h-[36px] rounded-[6px] border-2 border-[#e4e4e4] flex items-center justify-center hover:bg-white/5 transition-colors">
