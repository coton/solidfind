...
const SETTINGS = {
  ...
  // Categories: Construction & Renovation are permanent. Architecture, Interior, Real Estate
  // are activated progressively. Remove a name from this array in the back office to hide it.
  activeCategories: ['Construction', 'Renovation', 'Architecture', 'Interior', 'Real Estate'],
};
